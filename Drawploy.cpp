...
void drawPoly() {
	...
	pts.push_back(Point(300, 300)); pts.push_back(Point(350, 350));
	pts.push_back(Point(350, 300)); pts.push_back(Point(250, 350));
	polylines(img, pts, true, Scalar(255, 0, 0), 2, LINE_AA);
